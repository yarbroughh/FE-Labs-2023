...
let myTodoList = [];
myTodoList.push("water plants", "wash dishes", "vacuum");
console.log(myTodoList);
myTodoList.splice(1, 1);
console.log(myTodoList);
let yourTodoList = ["clean bathroom", "shovel sidewalk"];
...
/*
 * Step 1:  Create a function called whichArrayIsLonger. The purpose of this function is to determine 
