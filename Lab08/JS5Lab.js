 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting("Heather", "MI")
myGreeting.hello()
...
let yourBook = new Book("To Kill a Mockingbird", "Harper Lee");
 ...
 * Step 2: Create a method inside of Fruit that prints a description of the fruit to the console, for example:
 *  "A lime is green and has a sour taste."
...
// Look at the provided code below. Notice how Student and Teacher inherit from the Person class through
//  the use of the "extends" and "super" key words. Also, how Student has a redefined details method that 
// is more appropriate than the details method it would have inherited from the Person super class...
 ...
 * Step 6: Create two instances of Movie called movie1, use "Jurassic Park" and "Steven Spielberg" as it's arguments AND movie2, use 
